...
Title=Integrated cross-section (LO+PS)
XLabel=$\sqrt{s}$~[GeV]
YLabel=$\sigma_{pp\to e^+\nu \mu^+\nu jj}$~[fb]
...
Title=Inclusive jet cross section (LO+PS)
...
Title=Exclusive jet cross section (LO+PS)
XLabel=number of jets
YLabel=$\sigma_{pp\to e^+\nu \mu^+\nu jj}$~[fb]
RatioPlotSameStyle=1
LogY=0
...
Title=Dijet invariant mass (LO+PS)
...
Title=Transverse momentum of the leading jet (LO+PS)
...
Title=Rapidity of the leading jet (LO+PS)
XLabel=$y_{\rm j_1}$
YLabel=$d~\sigma_{pp\to e^+\nu \mu^+\nu jj}/d~y_{\rm j_1}$~[fb]
RatioPlotSameStyle=1
LogY=0
...
Title=Transverse momentum of the subleading jet (LO+PS)
...
Title=Rapidity of the subleading jet (LO+PS)
XLabel=$y_{\rm j_2}$
YLabel=$d~\sigma_{pp\to e^+\nu \mu^+\nu jj}/d~y_{\rm j_2}$~[fb]
RatioPlotSameStyle=1
LogY=0
...
Title=Dilepton invariant mass (LO+PS)
XLabel=$m_{e,\mu}$~[GeV]
YLabel=$d~\sigma_{pp\to e^+\nu \mu^+\nu jj}/d~m_{e,\mu}$~[fb/GeV]
RatioPlotSameStyle=1
# END PLOT

# BEGIN PLOT /MC_VBSCAN_MCComparison/z_e
Title=Normalised average rapidity of the electron (LO+PS)
XLabel=$z_{e}$
YLabel=$d~\sigma_{pp\to e^+\nu \mu^+\nu jj}/d~z_{e}$~[fb]
RatioPlotSameStyle=1
LogY=0
...
Title=Normalised average rapidity of the muon (LO+PS)
XLabel=$z_{\mu}$
YLabel=$d~\sigma_{pp\to e^+\nu \mu^+\nu jj}/d~z_{\mu}$~[fb]
RatioPlotSameStyle=1
LogY=0
...
Title=Transverse momentum of the third jet (LO+PS)
...
Title=Rapidity of the third jet (LO+PS)
XLabel=$y_{\rm j_3}$
YLabel=$d~\sigma_{pp\to e^+\nu \mu^+\nu jj}/d~y_{\rm j_3}$~[fb]
RatioPlotSameStyle=1
LogY=0
...
Title=Normalised average rapidity of the third jet (LO+PS)
XLabel=$z_{\rm j_3}$
YLabel=$d~\sigma_{pp\to e^+\nu \mu^+\nu jj}/d~z_{\rm j_3}$~[fb]
RatioPlotSameStyle=1
LogY=0
