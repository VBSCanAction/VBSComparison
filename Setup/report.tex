...
\caption{\label{fig:mjj-llLO}Invariant-mass of the two tagging jets (left) and of the two leptons (right).
}
\end{figure}
%
\begin{figure}[h!]
...
\caption{\label{fig:ptj1-2LO}Transverse momentum of the first (left) and second (right) tagging jet.
}
\end{figure}
%
\begin{figure}[h!]
...
\caption{\label{fig:yj1-2LO}Rapidity of the first (left) and second (right) tagging jet.
}
\end{figure}
%
\begin{figure}[h!]
...
\caption{\label{fig:zel-muLO}Zeppenfeld variable of the positron (left) and of the muon (right).
}
\end{figure}
