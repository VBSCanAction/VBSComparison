...
%DIF ADD article.tex                  Thu Jun 14 10:13:55 2018
...
\section{Leading-order study}
    ...
    of the various VBS approximations have an impact \DIFdelbegin \DIFdel{not larger than $0.5\%$ }\DIFdelend \DIFaddbegin \DIFadd{well below 1\% }\DIFaddend at the level of the fiducial cross section at LO for a 
...
%DIFDELCMD <     %%%
\DIFdelend \DIFaddbegin \DIFadd{Second, the four complete predictions (}{\sc \DIFadd{Whizard}}\DIFadd{, }{\sc \DIFadd{PHANTOM}}\DIFadd{, }{\sc \DIFadd{MG5\_aMC}} 
    \DIFadd{and }{\sc \DIFadd{MoCaNLO+Recola}}\DIFadd{) are not in statistical agreement. While we have checked the point-wise agreement of the matrix-element, 
    we cannot exclude other reasons for the disagreement, for example a non representative (i.e. too-aggressive) 
    estimate of the MonteCarlo uncertainty or 
    a non-perfect mapping of the six-body phase-space. However, the level of ambiguity is at the 0.5\% level, which 
    we deem satisfactory if compared to the larger differences we will observe at NLO or including matching to parton shower. 
