...
The approximations performed at LO can be extended when NLO QCD corrections to the $\mathcal{O}{\left(\alpha^{6}\right)}$ are computed.
...
\MP{@MZ g. gs are for amplitude and alpha, alphas for matrix element squared.}
