...
Thus the $\mathcal{O}(\alphas^2\alpha^4)$ diagrams only involve gluon exchanged in the $t/u$-channel between the quark lines.
This results in a small contributions although the VBS cuts have not been imposed.
