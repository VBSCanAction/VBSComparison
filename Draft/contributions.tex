At tree level, there are three contributions to the $\PW^+\PW^+$ production in association with two jets: the pure EW component $\mathcal{O}(\alpha^6)$, the interference $\mathcal{O}(\alphas\alpha^5)$, and the QCD background $\mathcal{O}(\alphas^2\alpha^4)$ \AK{We have mentioned this many times at this point. Perhaps not worth repeating again?}.
...
\MP{On the plots: it should be $\alpha$ and not $\alpha_{em}$ and $m_{\Pj\Pj}$ instead of $M_{jj}$. And we have the convention to put $\alphas$ before $\alpha$.}\AK{top,middle,bottom makes no sense here...}}
