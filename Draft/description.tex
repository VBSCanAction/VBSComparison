...
The virtuals are additionally approximated using a double pole approximation.
For more inclusive cross sections at LO the exact matrix elements ($s$-channels, interferences) are used.
