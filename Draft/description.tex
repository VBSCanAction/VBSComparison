...
\end{verbatim}
  ...
  and $e^+e^-$ colliders at $\alpha_{ew}^6$ and $\alpha_{ew}^4\alphas^2$ including interferences between the two sets of diagrams.
...
NLO QCD corrections at fixed-order $\mathcal O (\alpha^6\alphas)$, for the process ${\rm p}{\rm p}\to\mu^+\nu_\mu{\rm e}^+\nu_{\rm e}{\rm j}{\rm j}$.
