...
The NNPDF~3.0 parton distribution functions~(PDFs)~\cite{Ball:2014uwa} with five massles flavours,\footnote{For the process considered, no bottom (anti-)quarks appear in the initial or final state at LO and NLO.} 
...
\end{equation}
%
defined via the transverse momenta of the two hardest identified jets.\footnote{The renormalisation and factorisation scale employed in the {\sc Powheg-Box} slightly differ from the 
