...
\BJ{I would change that sentence to simply {\em Photon-induced processes are not considered.}, as there are more reasons for disregarding the photon-induced contributions. } 
...
\BJ{Should we say something about singularities due to soft photon exchange in the $t$-channel that are removed in VBFNLO and POWHEG by a technical cutoff?}
Note that no bottom-quark induced processes are included.
They would lead to top quarks in the final state which have a different experimental signature than two light jets, missing transverse energy, and two positively charged leptons.
...
\begin{itemize}
    ...
    \item The total missing transverse energy, computed from the vectorial sum of the transverse momenta of the two neutrinos, is required to be
        ...
        \end{align}
        %
    \item QCD partons (light quarks and gluons) are clustered together using the anti-$k_T$ algorithm~\cite{Cacciari:2008gp} with distance parameter $R=0.4$. %Jets are required to have
