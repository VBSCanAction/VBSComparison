...
\section{Details of the calculations}
    ...
    For more inclusive cross sections at LO the exact matrix elements ($s$-channels, interferences) can also be used.
      ...
      \item {\sc MadGraph5\_aMC@NLO}~\cite{Alwall:2014hca} (henceforth {\sc MG5\_aMC}) is a meta-code (a code that generates codes) which makes it possible to simulate any scattering process
    ...
    \end{verbatim}
      With these commands the complex-mass scheme is turned on, then the NLO-capable model is loaded\footnote{Despite
            ...
            Only strongly-interacting particles circulating in the loops are generated for the virtual matrix element.
...
the theoretical uncertainty obtained via scale variations (renormalisation, factorisation and shower scale) 
