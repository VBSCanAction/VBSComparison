...
%DIF DEL article.tex      Tue Mar 13 16:14:39 2018
%DIF ADD article_h7.tex   Tue Mar 13 16:16:09 2018
...
and {\sc \DIFdelbegin \DIFdel{Herwig++}\DIFdelend \DIFaddbegin \DIFadd{Herwig7}\DIFaddend }~\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{Bahr:2008pv, Bellm:2013hwb} }%DIFAUXCMD
(version 2.7.1). }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{Bellm:2015jjp,Bellm:2017bvx} }%DIFAUXCMD
(version 7.1.2). For the latter, the angular-ordered shower will be employed. 
}\DIFaddend The same parton showers will be employed for the LO results of {\sc PHANTOM} and {\sc Pythia8} will also be employed for the LO results of {\sc WHIZARD}. For the {\sc Powheg-Box}, the namesake
...
Ref.~\cite{Sirunyan:2017jej} Figure 12), where the experimental data seem to prefer the description by {\sc Herwig++}\DIFaddbegin \DIFadd{~\mbox{%DIFAUXCMD
\cite{Bahr:2008pv, Bellm:2013hwb}}%DIFAUXCMD
}\DIFaddend .
