...
This is in contrast with ({\sc BONSAY} and {\sc POWHEG}) which approximate the full computation reasonably well over the whole range and in particular the the high transverse-momentum region.
...
Concerning the rapidity of the hardest jet, {\sc VBFNLO} is in good agreement with {\sc MoCaNLO}+{\sc Recola} in the rapidity range $\pm3$.
...
The last set of differential distributions are the invariant mass of the two charged lepton (top) and the Zeppenfeld variable for the anti-muon (bottom).
...
The other three VBS approximations seem to be close to each other.
