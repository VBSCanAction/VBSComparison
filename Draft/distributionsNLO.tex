...
This difference can be attributed to EW Sudakov logarithms that become large in this phase-space region \ZM{I do not understand: MG5aMC is below
the full computation and in MG5aMC there are no EW corrections\ldots which Sudakov logs are we speaking about?}.
...
In the end, the quality of the VBS-approximations amount to tenths of per cent \ZM{tenths is too much\ldots I would say can reach/be as large as 10\%} depending on the observables and phase-space range.
