...
The features observed here (validity of the VBS approximation or comparison of theoretical predictions matched to parton shower, for example) should be qualitatively similar for other VBS signatures with massive gauge bosons. \BJ{I am not sure this statement is generally true. For other VBS channels, backgrounds are much more troublesome. If we want to make a statement like ``qualitatively similar for other VBS signatures'' we need to say more explicitly in which respect, for instance concerning the validity of the VBS approximation.}
