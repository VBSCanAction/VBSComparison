...
As expected, in the low invariant mass--low rapidity separation region of the jet pair ($200 \GeV < m_{\Pj\Pj} < 500 \GeV$, $2<|\Delta y_{\Pj\Pj}|<2.5$) the VBS approximation fails significantly ($29.4\%\%$ discrepancy).
The inclusion of the $s$-channel brings the difference down to $5.4\%$.
