...
the difference between the $|t|^2+|u|^2$ approximation and the full computation reaches $30\%$.
...
\caption{Ratios of double-differential distributions in the variables the variables $m_{\Pj\Pj}$ and $|\Delta y_{\Pj\Pj}|$ at NLO QCD \emph{i.e.}\ at order $\mathcal{O}(\alphas\alpha^6)$ for the VBS approximation over the full computation.
