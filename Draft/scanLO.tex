In Fig.~\ref{fig:ratio2d_LO}, ratios of double-differential cross sections in the plane $\left(m_{\Pj\Pj}, \Delta y_{\Pj\Pj}\right)$ is shown.
...
\AK{What are the MC error on these plots?} \GP{It would be hard to show them on the plot: I have uploaded the MC errors of each bin in th edirectory SCAN, both for fig.4 (LO) and fig.7 (NLO).}
