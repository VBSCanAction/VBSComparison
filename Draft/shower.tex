...
\caption{Exclusive jet multiplicity from predictions matched to parton shower, at LO (left) or NLO (right) accuracy, compared with the fixed-NLO result
    computed with \sc{VBFNLO}. \MP{The plots themselves should probably have the label LO and NLO for the FO+PS predictions. One should also describe how the bands are obtaineds.}}
\label{fig:PSnjet}
\end{figure*}
