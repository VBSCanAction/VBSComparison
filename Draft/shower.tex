...
\begin{table}[h!]
    ...
    \begin{tabular}{c|r@{ $\pm$ }l}
      Code  &  \multicolumn{2}{c}{$\sigma[\rm{fb}]$}  \\
        \hline\hline
        {\sc MG5\_aMC}+{\sc Pythia8}&  $1.450 ^{+XX}_{-YY} {}^{+XX}_{-YY} $ & $0.004$  \\
        ...
        {\sc VBFNLO}+{\sc Herwig7-Dipole} &  $1.3389 ^{+0.0}_{-1.0}$ & $0.0006$  \\
...
are respectively the nine-point scale uncertainty and the PDF one. Theory uncertainties are in percent.}
\end{table}
...
take into account the width effects described in the above paragraph.d  At NLO accuracy, for {\sc MG5\_aMC} + {\sc Pythia8} and {\sc VBFNLO}, we also quote
