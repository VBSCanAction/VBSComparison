...
must be employed in order not to bias the results. \ZM{lepton-jet separation at the hard-event level?} \AK{In powheg the separation is done after shower. So it's really the jet.}.
