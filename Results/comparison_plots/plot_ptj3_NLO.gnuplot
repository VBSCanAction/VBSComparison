...
set mxtics 10
set mytics 10
set ylabel "d{/Symbol s}/d p_{T,j_3} [pb/GeV]"
#set xtics nomirror
set format y "10^{%T}"
...
"<paste ../Recola/NLO/histogram_transverse_momentum_j3_nlo.dat ../MG5_aMC/NLO/Pt_j3_NLO.dat" u (($2+$3)/2):($45)/($4*RECOLA_fact*($3-$2)) ls 2 t 'MG5\_aMC',\
...
"<paste ../Recola/NLO/histogram_transverse_momentum_j3_nlo.dat ../Recola/NLO/histogram_transverse_momentum_j3_nlo.dat" u (($2+$3)/2):($46*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 4 t 'MoCaNLO+Recola',\
"<paste ../Recola/NLO/histogram_transverse_momentum_j3_nlo.dat ../BONSAY/NLO/ew-nlo.ptj3" u (($2+$3)/2):(BONSAY_fact*$44*10/($4*RECOLA_fact*($3-$2))) ls 6 t 'BONSAY',\
