...
plot \
"<paste ../VBFNLO/NLO/hist.ptj3.dat ../VBFNLO/NLO/hist.ptj3.dat" u (($1+$2)/2):($15*VBFNLO_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) ls 1 t 'VBFNLO',\
...
"<paste ../VBFNLO/NLO/hist.ptj3.dat ../Recola/NLO/histogram_transverse_momentum_j3_nlo.dat" u (($1+$2)/2):($12*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) ls 4 t 'Recola',\
