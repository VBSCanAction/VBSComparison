...
set mxtics 2
set mytics 10
set ylabel "d{/Symbol s}/d z_{{/Symbol m}^+} [fb]"
#set xtics nomirror
set format y "10^{%T}"
...
"../Recola/LO/histogram_zeppenfeld_zmup_born.dat" u ($2+0.001):(min($4,$10,$16,$22,$28,$34,$40)*RECOLA_fact*($3-$2)) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"../Recola/LO/histogram_zeppenfeld_zmup_born.dat" u ($2-0.001):(min($4,$10,$16,$22,$28,$34,$40)*RECOLA_fact*($3-$2)) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"../BONSAY/LO/ew-lo.zmu" u 1:(BONSAY_fact*$2*0.05) ls 6 t 'BONSAY',\
"../MG5_aMC/LO/z_mu_LO.dat" u (($1+$2)/2):($3*MADGRAPH_fact) ls 2 t 'MG5\_aMC',\
...
"<paste ../Recola/LO/histogram_zeppenfeld_zmup_born.dat ../Recola/LO/histogram_zeppenfeld_zmup_born.dat" u ($2+0.001):((min($4,$10,$16,$22,$28,$34,$40))*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"<paste ../Recola/LO/histogram_zeppenfeld_zmup_born.dat ../Recola/LO/histogram_zeppenfeld_zmup_born.dat" u ($2-0.001):((min($4,$10,$16,$22,$28,$34,$40))*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
...
"<paste ../Recola/LO/histogram_zeppenfeld_zmup_born.dat ../MG5_aMC/LO/z_mu_LO.dat" u (($2+$3)/2):($45*MADGRAPH_fact)/($4*RECOLA_fact*($3-$2)) ls 2 t 'MG5\_aMC',\
...
"<paste ../Recola/LO/histogram_zeppenfeld_zmup_born.dat ../PHANTOM/LO/EW6/zepp_mu.dat" using (($2+$3)/2):(($45*PHANTOM_fact*($3-$2))/($4*RECOLA_fact*($3-$2))) ls 8 title 'PHANTOM',\
"<paste ../Recola/LO/histogram_zeppenfeld_zmup_born.dat ../POWHEG/LO/zstar_-muon-_VBF_CUTS_index__13.dat" u (($2+$3)/2):($45*POWHEG_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 3 t 'POWHEG',\
"<paste ../Recola/LO/histogram_zeppenfeld_zmup_born.dat ../VBFNLO/LO/hist.zmu.dat" u (($2+$3)/2):($49*VBFNLO_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 1 t 'VBFNLO',\
"<paste ../Recola/LO/histogram_zeppenfeld_zmup_born.dat ../WHIZARD/LO/hist_zeppenfeldMuPlus.dat" using 43:(($44*WHIZARD_fact)/($4*RECOLA_fact*($3-$2))) ls 10 title 'WHIZARD',\
