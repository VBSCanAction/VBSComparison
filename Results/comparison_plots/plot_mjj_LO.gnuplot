...
"../Recola/LO/histogram_invariant_mass_mjj12_born.dat" u ($2+5):(min($4,$10,$16,$22,$28,$34,$40)*RECOLA_fact*($3-$2)) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"../Recola/LO/histogram_invariant_mass_mjj12_born.dat" u ($2-5):(min($4,$10,$16,$22,$28,$34,$40)*RECOLA_fact*($3-$2)) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
...
"<paste ../Recola/LO/histogram_invariant_mass_mjj12_born.dat ../Recola/LO/histogram_invariant_mass_mjj12_born.dat" u ($2+5):((min($4,$10,$16,$22,$28,$34,$40))*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"<paste ../Recola/LO/histogram_invariant_mass_mjj12_born.dat ../Recola/LO/histogram_invariant_mass_mjj12_born.dat" u ($2-5):((min($4,$10,$16,$22,$28,$34,$40))*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
