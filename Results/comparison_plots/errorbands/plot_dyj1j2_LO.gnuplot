...
"../../Recola/LO/histogram_rapidity_separation_abs_j1j2_born.dat" u (($1+$2)/2):($3*RECOLA_fact*($2-$1)) ls 4 t 'Recola',\
...
plot \
"<paste ../../VBFNLO/LO/hist.yjj.dat ../../VBFNLO/LO/hist.yjj.dat" u (($1+$2)/2):(($15+$16)*VBFNLO_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($15-$16)*VBFNLO_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 1 t 'VBFNLO',\
"<paste ../../VBFNLO/LO/hist.yjj.dat ../../MG5_aMC/LO/Dyjj_LO.dat" u (($1+$2)/2):($11+$12)/($7*VBFNLO_fact*($2-$1)):($11-$12)/($7*VBFNLO_fact*($2-$1)) with filledcurves ls 2 t 'MG5\_aMC',\
"<paste ../../VBFNLO/LO/hist.yjj.dat ../../POWHEG/LO/rap_j1j2tag_-_VBF_CUTS_index___4.dat" u (($1+$2)/2):(($11+$12)*POWHEG_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($11-$12)*POWHEG_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 3 t 'POWHEG',\
"<paste ../../VBFNLO/LO/hist.yjj.dat ../../Recola/LO/histogram_rapidity_separation_abs_j1j2_born.dat" u (($1+$2)/2):(($11+$12)*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($11-$12)*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 4 t 'Recola',\
"<paste ../../VBFNLO/LO/hist.yjj.dat ../../BONSAY/LO/ew-lo.dyjj" u (($1+$2)/2):(BONSAY_fact*($10+$11)*0.5/($7*VBFNLO_fact*($2-$1))):(BONSAY_fact*($10-$11)*0.5/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 6 t 'BONSAY',\
"<paste ../../VBFNLO/LO/hist.yjj.dat ../../WHIZARD/LO/hist_DeltaRapJets.dat" using 9:((($10+$11)*WHIZARD_fact)/($7*VBFNLO_fact*($2-$1))):((($10-$11)*WHIZARD_fact)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 10 title 'WHIZARD',\
"<paste ../../VBFNLO/LO/hist.yjj.dat ../../PHANTOM/LO/EW6/dyjj.dat" using (($1+$2)/2):((($11+$12)*PHANTOM_fact*($2-$1))/($7*VBFNLO_fact*($2-$1))):((($11-$12)*PHANTOM_fact*($2-$1))/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 8 title 'PHANTOM',\
