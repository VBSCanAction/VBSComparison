...
stats '../../WHIZARD/LO/hist_invariantMassOfTwoChargedLeptons.dat' every ::0 using 5 nooutput
...
"../../Recola/LO/histogram_invariant_mass_epmu_born.dat" u (($2+$3)/2):($4*RECOLA_fact*($3-$2)) ls 4 t 'Recola',\
...
plot \
"<paste ../../VBFNLO/LO/hist.mll.dat ../../VBFNLO/LO/hist.mll.dat" u (($1+$2)/2):(($15+$16)*VBFNLO_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($15-$16)*VBFNLO_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 1 t 'VBFNLO',\
"<paste ../../VBFNLO/LO/hist.mll.dat ../../MG5_aMC/LO/M_lep_lep_LO.dat" u (($1+$2)/2):($11+$12)/($7*VBFNLO_fact*($2-$1)):($11-$12)/($7*VBFNLO_fact*($2-$1)) with filledcurves ls 2 t 'MG5\_aMC',\
"<paste ../../VBFNLO/LO/hist.mll.dat ../../POWHEG/LO/Ml1l2-_VBF_CUTS_index__11.dat" u (($1+$2)/2):(($11+$12)*POWHEG_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($11-$12)*POWHEG_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 3 t 'POWHEG',\
"<paste ../../VBFNLO/LO/hist.mll.dat ../../Recola/LO/histogram_invariant_mass_epmu_born.dat" u (($1+$2)/2):(($11+$12)*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($11-$12)*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 4 t 'Recola',\
"<paste ../../VBFNLO/LO/hist.mll.dat ../../BONSAY/LO/ew-lo.mll" u (($1+$2)/2):(BONSAY_fact*($10+$11)*100/($7*VBFNLO_fact*($2-$1))):(BONSAY_fact*($10-$11)*100/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 6 t 'BONSAY',\
"<paste ../../VBFNLO/LO/hist.mll.dat ../../WHIZARD/LO/hist_invariantMassOfTwoChargedLeptons.dat" using 9:((($10+$11)*WHIZARD_fact)/($7*VBFNLO_fact*($2-$1))):((($10-$11)*WHIZARD_fact)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 10 title 'WHIZARD',\
"<paste ../../VBFNLO/LO/hist.mll.dat ../../PHANTOM/LO/EW6/mll.dat" using (($1+$2)/2):((($11+$12)*PHANTOM_fact*($2-$1))/($7*VBFNLO_fact*($2-$1))):((($11-$12)*PHANTOM_fact*($2-$1))/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 8 title 'PHANTOM',\
