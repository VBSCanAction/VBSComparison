...
"../../Recola/LO/histogram_rapidity_j1_born.dat" u (($2+$3)/2):($4*RECOLA_fact*($3-$2)) ls 4 t 'Recola',\
...
"<paste ../../VBFNLO/LO/hist.yj1.dat ../../Recola/LO/histogram_rapidity_j1_born.dat" u (($1+$2)/2):(($11+$12)*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($11-$12)*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 4 t 'Recola',\
