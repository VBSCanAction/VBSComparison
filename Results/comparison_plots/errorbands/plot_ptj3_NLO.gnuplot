...
plot \
"../../VBFNLO/NLO/hist.ptj3.dat" u (($1+$2)/2):($7*VBFNLO_fact*($2-$1)) ls 1 t 'VBFNLO',\
...
"../../Recola/NLO/histogram_transverse_momentum_j3_nlo.dat" u (($2+$3)/2):($4*RECOLA_fact*($3-$2)) ls 4 t 'Recola',\
...
unset format y
unset key
set xlabel 'P_T(j_3) [GeV]'

set ylabel 'Ratio /VBFNLO' offset 1

plot \
"<paste ../../VBFNLO/NLO/hist.ptj3.dat ../../VBFNLO/NLO/hist.ptj3.dat" u (($1+$2)/2):(($15+$16)*VBFNLO_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($15-$16)*VBFNLO_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 1 t 'VBFNLO',\
"<paste ../../VBFNLO/NLO/hist.ptj3.dat ../../MG5_aMC/NLO/Pt_j3_NLO.dat" u (($1+$2)/2):($11+$12)/($7*VBFNLO_fact*($2-$1)):($11-$12)/($7*VBFNLO_fact*($2-$1)) with filledcurves ls 2 t 'MG5\_aMC',\
"<paste ../../VBFNLO/NLO/hist.ptj3.dat ../../POWHEG/NLO/PT_jet_3-_VBF_CUTS_index___7.dat" u (($1+$2)/2):(($11+$12)*POWHEG_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($11-$12)*POWHEG_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 3 t 'POWHEG',\
"<paste ../../VBFNLO/NLO/hist.ptj3.dat ../../Recola/NLO/histogram_transverse_momentum_j3_nlo.dat" u (($1+$2)/2):(($11+$12)*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($11-$12)*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 4 t 'Recola',\
"<paste ../../VBFNLO/NLO/hist.ptj3.dat ../../BONSAY/NLO/ew-nlo.ptj3" u (($1+$2)/2):(BONSAY_fact*($10+$11)*10/($7*VBFNLO_fact*($2-$1))):(BONSAY_fact*($10-$11)*10/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 6 t 'BONSAY',\
