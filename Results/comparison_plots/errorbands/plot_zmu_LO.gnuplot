...
stats '../../WHIZARD/LO/hist_zeppenfeldMuPlus.dat' every ::0 using 5 nooutput
...
plot \
"../../VBFNLO/LO/hist.zmu.dat" u (($1+$2)/2):($7*VBFNLO_fact*($2-$1)) ls 1 t 'VBFNLO',\
"../../MG5_aMC/LO/z_mu_LO.dat" u (($1+$2)/2):($3) ls 2 t 'MG5\_aMC',\
"../../POWHEG/LO/zstar_-muon-_VBF_CUTS_index__13.dat" u (($1+$2)/2):($3*POWHEG_fact*($2-$1)) ls 3 t 'POWHEG',\
"../../Recola/LO/histogram_zeppenfeld_zmup_born.dat" u (($1+$2)/2):($3*RECOLA_fact*($2-$1)) ls 4 t 'Recola',\
"../../BONSAY/LO/ew-lo.zmu" u 1:(BONSAY_fact*$2*0.05) ls 6 t 'BONSAY',\
"../../WHIZARD/LO/hist_zeppenfeldMuPlus.dat" using 1:($2*WHIZARD_fact) ls 10 title 'WHIZARD',\
"../../PHANTOM/LO/EW6/zepp_mu.dat" using (($1+$2)/2):($3*PHANTOM_fact*($2-$1)) ls 8 title 'PHANTOM',\
...
plot \
"<paste ../../VBFNLO/LO/hist.zmu.dat ../../VBFNLO/LO/hist.zmu.dat" u (($1+$2)/2):(($15+$16)*VBFNLO_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($15-$16)*VBFNLO_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 1 t 'VBFNLO',\
"<paste ../../VBFNLO/LO/hist.zmu.dat ../../MG5_aMC/LO/z_mu_LO.dat" u (($1+$2)/2):($11+$12)/($7*VBFNLO_fact*($2-$1)):($11-$12)/($7*VBFNLO_fact*($2-$1)) with filledcurves ls 2 t 'MG5\_aMC',\
"<paste ../../VBFNLO/LO/hist.zmu.dat ../../POWHEG/LO/zstar_-muon-_VBF_CUTS_index__13.dat" u (($1+$2)/2):(($11+$12)*POWHEG_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($11-$12)*POWHEG_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 3 t 'POWHEG',\
"<paste ../../VBFNLO/LO/hist.zmu.dat ../../Recola/LO/histogram_zeppenfeld_zmup_born.dat" u (($1+$2)/2):(($11+$12)*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($11-$12)*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 4 t 'Recola',\
"<paste ../../VBFNLO/LO/hist.zmu.dat ../../BONSAY/LO/ew-lo.zmu" u (($1+$2)/2):(BONSAY_fact*($10+$11)*0.05/($7*VBFNLO_fact*($2-$1))):(BONSAY_fact*($10-$11)*0.05/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 6 t 'BONSAY',\
"<paste ../../VBFNLO/LO/hist.zmu.dat ../../WHIZARD/LO/hist_zeppenfeldMuPlus.dat" using 9:((($10+$11)*WHIZARD_fact)/($7*VBFNLO_fact*($2-$1))):((($10-$11)*WHIZARD_fact)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 10 title 'WHIZARD',\
"<paste ../../VBFNLO/LO/hist.zmu.dat ../../PHANTOM/LO/EW6/zepp_mu.dat" using (($1+$2)/2):((($11+$12)*PHANTOM_fact*($2-$1))/($7*VBFNLO_fact*($2-$1))):((($11-$12)*PHANTOM_fact*($2-$1))/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 8 title 'PHANTOM',\
