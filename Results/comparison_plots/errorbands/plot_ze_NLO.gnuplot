...
"../../Recola/NLO/histogram_zeppenfeld_zep_nlo.dat" u (($2+$3)/2):($4*RECOLA_fact*($3-$2)) ls 4 t 'Recola',\
...
plot \
"<paste ../../VBFNLO/NLO/hist.ze.dat ../../VBFNLO/NLO/hist.ze.dat" u (($1+$2)/2):(($15+$16)*VBFNLO_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($15-$16)*VBFNLO_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 1 t 'VBFNLO',\
"<paste ../../VBFNLO/NLO/hist.ze.dat ../../MG5_aMC/NLO/z_el_NLO.dat" u (($1+$2)/2):($11+$12)/($7*VBFNLO_fact*($2-$1)):($11-$12)/($7*VBFNLO_fact*($2-$1)) with filledcurves ls 2 t 'MG5\_aMC',\
"<paste ../../VBFNLO/NLO/hist.ze.dat ../../POWHEG/NLO/zstar_-electron-_VBF_CUTS_index__12.dat" u (($1+$2)/2):(($11+$12)*POWHEG_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($11-$12)*POWHEG_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 3 t 'POWHEG',\
"<paste ../../VBFNLO/NLO/hist.ze.dat ../../Recola/NLO/histogram_zeppenfeld_zep_nlo.dat" u (($1+$2)/2):(($11+$12)*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))):(($11-$12)*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 4 t 'Recola',\
"<paste ../../VBFNLO/NLO/hist.ze.dat ../../BONSAY/NLO/ew-nlo.ze" u (($1+$2)/2):(BONSAY_fact*($10+$11)*0.05/($7*VBFNLO_fact*($2-$1))):(BONSAY_fact*($10-$11)*0.05/($7*VBFNLO_fact*($2-$1))) with filledcurves ls 6 t 'BONSAY',\
