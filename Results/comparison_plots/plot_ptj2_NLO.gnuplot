...
plot \
"<paste ../Recola/NLO/histogram_transverse_momentum_j2_nlo.dat ../VBFNLO/NLO/hist.ptj2.dat" u (($2+$3)/2):($25*VBFNLO_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 1 t 'VBFNLO',\
"<paste ../Recola/NLO/histogram_transverse_momentum_j2_nlo.dat ../MG5_aMC/NLO/Pt_j2_NLO.dat" u (($2+$3)/2):($21)/($4*RECOLA_fact*($3-$2)) ls 2 t 'MG5\_aMC',\
"<paste ../Recola/NLO/histogram_transverse_momentum_j2_nlo.dat ../POWHEG/NLO/PT_jet_2-_VBF_CUTS_index___6.dat" u (($2+$3)/2):($21*POWHEG_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 3 t 'POWHEG',\
"<paste ../Recola/NLO/histogram_transverse_momentum_j2_nlo.dat ../Recola/NLO/histogram_transverse_momentum_j2_nlo.dat" u (($2+$3)/2):($22*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 4 t 'MoCaNLO+Recola',\
"<paste ../Recola/NLO/histogram_transverse_momentum_j2_nlo.dat ../BONSAY/NLO/ew-nlo.ptj2" u (($2+$3)/2):(BONSAY_fact*$20*25/($4*RECOLA_fact*($3-$2))) ls 6 t 'BONSAY',\
