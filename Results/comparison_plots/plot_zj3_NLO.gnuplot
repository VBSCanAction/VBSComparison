...
set format x ''
set key at graph 0.4, graph 0.55 noautotitles spacing 2.4
...
plot \
"<paste ../Recola/NLO/histogram_zeppenfeld_zj3_nlo.dat ../VBFNLO/NLO/hist.zj3.dat" u (($2+$3)/2):($25*VBFNLO_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 1 t 'VBFNLO',\
"<paste ../Recola/NLO/histogram_zeppenfeld_zj3_nlo.dat ../MG5_aMC/NLO/z_j3_NLO.dat" u (($2+$3)/2):($21)/($4*RECOLA_fact*($3-$2)) ls 2 t 'MG5\_aMC',\
"<paste ../Recola/NLO/histogram_zeppenfeld_zj3_nlo.dat ../POWHEG/NLO/zstar_-j3-_VBF_CUTS_index__14.dat" u (($2+$3)/2):($21*POWHEG_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 3 t 'POWHEG',\
"<paste ../Recola/NLO/histogram_zeppenfeld_zj3_nlo.dat ../Recola/NLO/histogram_zeppenfeld_zj3_nlo.dat" u (($2+$3)/2):($22*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 4 t 'MoCaNLO+Recola',\
"<paste ../Recola/NLO/histogram_zeppenfeld_zj3_nlo.dat ../BONSAY/NLO/ew-nlo.zj3s" u (($2+$3)/2):(BONSAY_fact*$20*0.05/($4*RECOLA_fact*($3-$2))) ls 6 t 'BONSAY',\
