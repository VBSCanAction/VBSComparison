...
"../BONSAY/NLO/nlo0-9.vbscan_yj1" u 1:(BONSAY_fact*$2*0.5) ls 6 t 'BONSAY',\
...
"<paste ../VBFNLO/LO/hist.yj1.dat ../BONSAY/NLO/nlo0-9.vbscan_yj1" u (($1+$2)/2):(BONSAY_fact*$10*0.5/($7*VBFNLO_fact*($2-$1))) ls 6 t 'BONSAY',\
