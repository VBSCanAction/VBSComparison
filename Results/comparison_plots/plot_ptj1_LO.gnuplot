...
"../POWHEG/LO/PT_jet_1-_VBF_CUTS_index___4.dat" u (($1+$2)/2):($3*POWHEG_fact*($2-$1)) ls 3 t 'POWHEG',\
"../Recola/LO/histogram_transverse_momentum_j1_born.dat" u (($1+$2)/2):($3*RECOLA_fact*($2-$1)) ls 4 t 'Recola',\
"../PSI/NLO/nlo0-9.vbscan_ptj1" u 1:(PSI_fact*$2*25) ls 6 t 'PSI',\
...
"<paste ../VBFNLO/LO/hist.ptj1.dat ../POWHEG/LO/PT_jet_1-_VBF_CUTS_index___4.dat" u (($1+$2)/2):($11*POWHEG_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) ls 3 t 'POWHEG',\
...
"<paste ../VBFNLO/LO/hist.ptj1.dat ../PSI/NLO/nlo0-9.vbscan_ptj1" u (($1+$2)/2):(PSI_fact*$10*25/($7*VBFNLO_fact*($2-$1))) ls 6 t 'PSI',\
