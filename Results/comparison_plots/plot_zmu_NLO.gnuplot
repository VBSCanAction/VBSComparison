...
plot \
"../Recola/NLO/histogram_zeppenfeld_zmup_nlo.dat" u 2:((max($4,$10,$16,$22,$28,$34,$40))*RECOLA_fact*($3-$2)) w fillsteps fs solid 0.3 ls 4 notitle,\
"../Recola/NLO/histogram_zeppenfeld_zmup_nlo.dat" u ($2+0.001):(min($4,$10,$16,$22,$28,$34,$40)*RECOLA_fact*($3-$2)) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"../Recola/NLO/histogram_zeppenfeld_zmup_nlo.dat" u ($2-0.001):(min($4,$10,$16,$22,$28,$34,$40)*RECOLA_fact*($3-$2)) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
...
plot \
"<paste ../Recola/NLO/histogram_zeppenfeld_zmup_nlo.dat ../Recola/NLO/histogram_zeppenfeld_zmup_nlo.dat" u 2:((max($4,$10,$16,$22,$28,$34,$40))*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) w fillsteps fs solid 0.3 ls 4 notitle,\
"<paste ../Recola/NLO/histogram_zeppenfeld_zmup_nlo.dat ../Recola/NLO/histogram_zeppenfeld_zmup_nlo.dat" u ($2+0.001):((min($4,$10,$16,$22,$28,$34,$40))*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"<paste ../Recola/NLO/histogram_zeppenfeld_zmup_nlo.dat ../Recola/NLO/histogram_zeppenfeld_zmup_nlo.dat" u ($2-0.001):((min($4,$10,$16,$22,$28,$34,$40))*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
