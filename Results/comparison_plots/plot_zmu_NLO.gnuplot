...
"../BONSAY/NLO/nlo0-9.vbscan_zmu" u 1:(BONSAY_fact*($2+$5+$8+$11)*0.05) ls 6 t 'BONSAY',\
...
"<paste ../VBFNLO/NLO/hist.zmu.dat ../BONSAY/NLO/nlo0-9.vbscan_zmu" u (($1+$2)/2):(BONSAY_fact*($10+$13+$16+$19)*0.05/($7*VBFNLO_fact*($2-$1))) ls 6 t 'BONSAY',\
