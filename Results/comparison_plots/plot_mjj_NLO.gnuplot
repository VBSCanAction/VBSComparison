...
"../PSI/NLO/nlo0-9.vbscan_mjj" u 1:(PSI_fact*($2+$5+$8+$11)*100) ls 6 t 'PSI',\
...
"<paste ../VBFNLO/NLO/hist.mjj.dat ../PSI/NLO/nlo0-9.vbscan_mjj" u (($1+$2)/2):(PSI_fact*($10+$13+$16+$19)*100/($7*VBFNLO_fact*($2-$1))) ls 6 t 'PSI',\
