...
"../BONSAY/NLO/nlo0-9.vbscan_mjj" u 1:(BONSAY_fact*($2+$5+$8+$11)*100) ls 6 t 'BONSAY',\
...
"<paste ../VBFNLO/NLO/hist.mjj.dat ../BONSAY/NLO/nlo0-9.vbscan_mjj" u (($1+$2)/2):(BONSAY_fact*($10+$13+$16+$19)*100/($7*VBFNLO_fact*($2-$1))) ls 6 t 'BONSAY',\
