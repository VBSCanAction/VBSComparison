...
set mxtics 2
set mytics 10
set ylabel "d{/Symbol s}/d y_{j_2} [pb]"
#set xtics nomirror
set format y "10^{%T}"
...
"../Recola/NLO/histogram_rapidity_j2_nlo.dat" u ($2+0.01):(min($4,$10,$16,$22,$28,$34,$40)*RECOLA_fact*($3-$2)) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"../Recola/NLO/histogram_rapidity_j2_nlo.dat" u ($2-0.01):(min($4,$10,$16,$22,$28,$34,$40)*RECOLA_fact*($3-$2)) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"../BONSAY/NLO/ew-nlo.yj2" u 1:(BONSAY_fact*$2*0.5) ls 6 t 'BONSAY',\
"../MG5_aMC/NLO/y_j2_NLO.dat" u (($1+$2)/2):($3*MADGRAPH_fact) ls 2 t 'MG5\_aMC',\
...
plot \
"<paste ../Recola/NLO/histogram_rapidity_j2_nlo.dat ../Recola/NLO/histogram_rapidity_j2_nlo.dat" u 2:((max($4,$10,$16,$22,$28,$34,$40))*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) w fillsteps fs solid 0.3 ls 4 notitle,\
"<paste ../Recola/NLO/histogram_rapidity_j2_nlo.dat ../Recola/NLO/histogram_rapidity_j2_nlo.dat" u ($2+0.01):((min($4,$10,$16,$22,$28,$34,$40))*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"<paste ../Recola/NLO/histogram_rapidity_j2_nlo.dat ../Recola/NLO/histogram_rapidity_j2_nlo.dat" u ($2-0.01):((min($4,$10,$16,$22,$28,$34,$40))*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"<paste ../Recola/NLO/histogram_rapidity_j2_nlo.dat ../BONSAY/NLO/ew-nlo.yj2" u (($2+$3)/2):(BONSAY_fact*$44*0.5/($4*RECOLA_fact*($3-$2))) ls 6 t 'BONSAY',\
"<paste ../Recola/NLO/histogram_rapidity_j2_nlo.dat ../MG5_aMC/NLO/y_j2_NLO.dat" u (($2+$3)/2):($45*MADGRAPH_fact)/($4*RECOLA_fact*($3-$2)) ls 2 t 'MG5\_aMC',\
"<paste ../Recola/NLO/histogram_rapidity_j2_nlo.dat ../Recola/NLO/histogram_rapidity_j2_nlo.dat" u (($2+$3)/2):($46*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 4 t 'MoCaNLO+Recola',\
"<paste ../Recola/NLO/histogram_rapidity_j2_nlo.dat ../POWHEG/NLO/Y_jet_2-_VBF_CUTS_index___9.dat" u (($2+$3)/2):($45*POWHEG_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 3 t 'POWHEG',\
"<paste ../Recola/NLO/histogram_rapidity_j2_nlo.dat ../VBFNLO/NLO/hist.yj2.dat" u (($2+$3)/2):($49*VBFNLO_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 1 t 'VBFNLO',\
