...
"../BONSAY/NLO/nlo0-9.vbscan_ptj2" u 1:(BONSAY_fact*$2*25) ls 6 t 'BONSAY',\
...
"<paste ../VBFNLO/LO/hist.ptj2.dat ../BONSAY/NLO/nlo0-9.vbscan_ptj2" u (($1+$2)/2):(BONSAY_fact*$10*25/($7*VBFNLO_fact*($2-$1))) ls 6 t 'BONSAY',\
