...
"../PSI/NLO/nlo0-9.vbscan_ptj2" u 1:(PSI_fact*$2*25) ls 6 t 'PSI',\
...
"<paste ../VBFNLO/LO/hist.ptj2.dat ../PSI/NLO/nlo0-9.vbscan_ptj2" u (($1+$2)/2):(PSI_fact*$10*25/($7*VBFNLO_fact*($2-$1))) ls 6 t 'PSI',\
