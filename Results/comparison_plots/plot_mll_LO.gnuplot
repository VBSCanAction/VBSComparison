...
"../POWHEG/LO/Ml1l2-_VBF_CUTS_index___8.dat" u (($1+$2)/2):($3*POWHEG_fact*($2-$1)) ls 3 t 'POWHEG',\
"../Recola/LO/histogram_invariant_mass_epmu_born.dat" u (($1+$2)/2):($3*RECOLA_fact*($2-$1)) ls 4 t 'Recola',\
"../PSI/NLO/nlo0-9.vbscan_mll" u 1:(PSI_fact*$2*100) ls 6 t 'PSI',\
...
"<paste ../VBFNLO/LO/hist.mll.dat ../PSI/NLO/nlo0-9.vbscan_mll" u (($1+$2)/2):(PSI_fact*$10*100/($7*VBFNLO_fact*($2-$1))) ls 6 t 'PSI',\
