...
"../PSI/LO/lord9.vbscan_mll" u 1:(PSI_fact*$2*100) ls 5 t 'PSI',\
...
"<paste ../VBFNLO/LO/hist.mll.dat ../PSI/LO/lord9.vbscan_mll" u (($1+$2)/2):(PSI_fact*$10*100/($7*VBFNLO_fact*($2-$1))) ls 5 t 'PSI',\
