...
"<paste ../VBFNLO/LO/hist.mll.dat ../Recola/LO/histogram_invariant_mass_epmu_born.dat" u (($1+$2)/2):($12*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) ls 4 t 'Recola',\
...
"<paste ../VBFNLO/LO/hist.mll.dat ../PHANTOM/LO/EW6/mll.dat" using (($1+$2)/2):(($11*PHANTOM_fact*($2-$1))/($7*VBFNLO_fact*($2-$1))) ls 8 title 'PHANTOM',\
