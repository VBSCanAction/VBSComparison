...
"../Recola/LO/histogram_invariant_mass_epmu_born.dat" u ($2+1):(min($4,$10,$16,$22,$28,$34,$40)*RECOLA_fact*($3-$2)) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"../Recola/LO/histogram_invariant_mass_epmu_born.dat" u ($2-1):(min($4,$10,$16,$22,$28,$34,$40)*RECOLA_fact*($3-$2)) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"../BONSAY/LO/ew-lo.mll" u 1:(BONSAY_fact*$2*100) ls 6 t 'BONSAY',\
"../MG5_aMC/LO/M_lep_lep_LO.dat" u (($1+$2)/2):($3*MADGRAPH_fact) ls 2 t 'MG5\_aMC',\
...
"<paste ../Recola/LO/histogram_invariant_mass_epmu_born.dat ../Recola/LO/histogram_invariant_mass_epmu_born.dat" u ($2+1):((min($4,$10,$16,$22,$28,$34,$40))*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
"<paste ../Recola/LO/histogram_invariant_mass_epmu_born.dat ../Recola/LO/histogram_invariant_mass_epmu_born.dat" u ($2-1):((min($4,$10,$16,$22,$28,$34,$40))*RECOLA_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) w fillsteps fs solid 1 lw 4 lc rgb 'white' notitle,\
...
"<paste ../Recola/LO/histogram_invariant_mass_epmu_born.dat ../MG5_aMC/LO/M_lep_lep_LO.dat" u (($2+$3)/2):($45*MADGRAPH_fact)/($4*RECOLA_fact*($3-$2)) ls 2 t 'MG5\_aMC',\
...
"<paste ../Recola/LO/histogram_invariant_mass_epmu_born.dat ../PHANTOM/LO/EW6/mll.dat" using (($2+$3)/2):(($45*PHANTOM_fact*($3-$2))/($4*RECOLA_fact*($3-$2))) ls 8 title 'PHANTOM',\
"<paste ../Recola/LO/histogram_invariant_mass_epmu_born.dat ../POWHEG/LO/Ml1l2-_VBF_CUTS_index__11.dat" u (($2+$3)/2):($45*POWHEG_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 3 t 'POWHEG',\
"<paste ../Recola/LO/histogram_invariant_mass_epmu_born.dat ../VBFNLO/LO/hist.mll.dat" u (($2+$3)/2):($49*VBFNLO_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 1 t 'VBFNLO',\
"<paste ../Recola/LO/histogram_invariant_mass_epmu_born.dat ../WHIZARD/LO/hist_invariantMassOfTwoChargedLeptons.dat" using 43:(($44*WHIZARD_fact)/($4*RECOLA_fact*($3-$2))) ls 10 title 'WHIZARD',\
