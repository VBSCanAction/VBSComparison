...
"<paste ../VBFNLO/NLO/hist.yj1.dat ../Recola/NLO/histogram_rapidity_j1_nlo.dat" u (($1+$2)/2):($12*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) ls 4 t 'Recola',\
"<paste ../VBFNLO/NLO/hist.yj1.dat ../BONSAY/NLO/ew-nlo.yj1" u (($1+$2)/2):(BONSAY_fact*$10*0.5/($7*VBFNLO_fact*($2-$1))) ls 6 t 'BONSAY',\
