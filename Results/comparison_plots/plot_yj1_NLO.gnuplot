...
"../MG5_aMC/NLO/y_j1_NLO.dat" u (($1+$2)/2):($3*MADGRAPH_fact) ls 2 t 'MG5\_aMC',\
...
"<paste ../Recola/NLO/histogram_rapidity_j1_nlo.dat ../MG5_aMC/NLO/y_j1_NLO.dat" u (($2+$3)/2):($45*MADGRAPH_fact)/($4*RECOLA_fact*($3-$2)) ls 2 t 'MG5\_aMC',\
...
"<paste ../Recola/NLO/histogram_rapidity_j1_nlo.dat ../POWHEG/NLO/Y_jet_1-_VBF_CUTS_index___8.dat" u (($2+$3)/2):($45*POWHEG_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 3 t 'POWHEG',\
"<paste ../Recola/NLO/histogram_rapidity_j1_nlo.dat ../VBFNLO/NLO/hist.yj1.dat" u (($2+$3)/2):($49*VBFNLO_fact*($3-$2)/($4*RECOLA_fact*($3-$2))) ls 1 t 'VBFNLO',\
