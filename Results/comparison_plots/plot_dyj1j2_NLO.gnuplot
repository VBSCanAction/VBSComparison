...
"../MG5_aMC/NLO/dy_j1j2_NLO.dat" u (($1+$2)/2):($3) ls 2 t 'MG5\_aMC',\
...
"<paste ../VBFNLO/NLO/hist.yjj.dat ../MG5_aMC/NLO/dy_j1j2_NLO.dat" u (($1+$2)/2):($11)/($7*VBFNLO_fact*($2-$1)) ls 2 t 'MG5\_aMC',\
...
"<paste ../VBFNLO/NLO/hist.yjj.dat ../Recola/NLO/histogram_rapiditdy_j1j2_born.dat" u (($1+$2)/2):($11*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) ls 4 t 'Recola',\
