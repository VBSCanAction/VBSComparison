...
"<paste ../VBFNLO/LO/hist.yj2.dat ../Recola/LO/histogram_rapidity_j2_born.dat" u (($1+$2)/2):($12*RECOLA_fact*($2-$1)/($7*VBFNLO_fact*($2-$1))) ls 4 t 'Recola',\
"<paste ../VBFNLO/LO/hist.yj2.dat ../BONSAY/LO/ew-lo.yj2" u (($1+$2)/2):(BONSAY_fact*$10*0.5/($7*VBFNLO_fact*($2-$1))) ls 6 t 'BONSAY',\
...
"<paste ../VBFNLO/LO/hist.yj2.dat ../PHANTOM/LO/EW6/yj2.dat" using (($1+$2)/2):(($11*PHANTOM_fact*($2-$1))/($7*VBFNLO_fact*($2-$1))) ls 8 title 'PHANTOM',\
