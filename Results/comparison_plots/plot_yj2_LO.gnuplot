...
"../PSI/NLO/nlo0-9.vbscan_yj2" u 1:(PSI_fact*$2*0.5) ls 6 t 'PSI',\
...
"<paste ../VBFNLO/LO/hist.yj2.dat ../PSI/NLO/nlo0-9.vbscan_yj2" u (($1+$2)/2):(PSI_fact*$10*0.5/($7*VBFNLO_fact*($2-$1))) ls 6 t 'PSI',\
