...
set mxtics 2
set mytics 10
set ylabel "d{/Symbol s}/d y_{j_3} [pb]"
#set xtics nomirror
set format y "10^{%T}"
...
"../MG5_aMC/NLO/y_j3_NLO.dat" u (($1+$2)/2):($3*MADGRAPH_fact) ls 2 t 'MG5\_aMC',\
...
"<paste ../Recola/NLO/histogram_rapidity_j3_nlo.dat ../MG5_aMC/NLO/y_j3_NLO.dat" u (($2+$3)/2):($45*MADGRAPH_fact)/($4*RECOLA_fact*($3-$2)) ls 2 t 'MG5\_aMC',\
