...
output
    \end{verbatim}
      With these commands the complex-mass scheme is turned on, then the NLO-capable model is loaded\footnote{Despite
            ...
            Only QCD-in\-ter\-act\-ing particles circulating in the loops are generated for the virtual matrix element.
...
the theoretical uncertainty obtained via scale variations (renormalization, factorization and show\-er scale) 
