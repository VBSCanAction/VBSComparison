...
Such a contribution is normally small ($3\%$) within typical experimental cuts~\cite{Biedermann:2017bss}.
...
possibly related to the underlying approximation performed ({\sc MG5\_aMC} is the only tool to use the full matrix elment for the real radiation), in particular the inclusion of the $s$-channel contributions: the largest rate is predicted by
